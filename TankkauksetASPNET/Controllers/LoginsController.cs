...
namespace TankkauksetASPNET.Controllers
{
    public class LoginsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LoginId,Username,Password,ErrorMessage")] Logins logins)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LoginId,Username,Password,ErrorMessage")] Logins logins)
        {
            if (ModelState.IsValid)
            {
